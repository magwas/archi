    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case IArchimatePackage.ARCHIMATE_MODEL: {
				...
				if (result == null) result = caseDocumentable(archimateModel);
			...
			case IArchimatePackage.ARCHIMATE_MODEL_ELEMENT: {
				...
				if (result == null) result = caseIdentifier(archimateModelElement);
				if (result == null) result = caseNameable(archimateModelElement);
				if (result == null) result = caseProperties(archimateModelElement);
				if (result == null) result = caseDocumentable(archimateModelElement);
